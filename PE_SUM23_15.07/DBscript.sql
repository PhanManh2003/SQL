...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'PE_DBI202_SU23_1507')
BEGIN
	ALTER DATABASE [PE_DBI202_SU23_1507] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [PE_DBI202_SU23_1507] SET ONLINE;
	DROP DATABASE [PE_DBI202_SU23_1507];
END

GO

CREATE DATABASE [PE_DBI202_SU23_1507]
GO

USE [PE_DBI202_SU23_1507]
GO
